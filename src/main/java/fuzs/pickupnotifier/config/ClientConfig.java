...
public class ClientConfig extends AbstractConfig {
    ...
    public static class BehaviorConfig extends AbstractConfig {
        ...
        @Override
        protected void addToBuilder(ForgeConfigSpec.Builder builder, ConfigHolder.ConfigCallback saveCallback) {
            saveCallback.accept(builder.comment("Disable specific items or content from whole mods from showing.", EntryCollectionBuilder.CONFIG_DESCRIPTION).define("Blacklist", Lists.<String>newArrayList()), v -> this.blacklist = EntryCollectionBuilder.of(Registry.ITEM).buildSet(v));
