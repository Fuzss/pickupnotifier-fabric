...
public class ConfigSync {
    ...
    public static final ResourceLocation SYNC_CONFIGS_CHANNEL = new ResourceLocation(ForgeConfigs.MODID, "sync_configs");
    public static final ResourceLocation MODDED_CONNECTION_CHANNEL = new ResourceLocation(ForgeConfigs.MODID, "modded_connection");
