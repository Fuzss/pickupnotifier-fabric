...
public class TestConfig {
    ...
    public static final TestConfig.Client CLIENT;

    static {
        final Pair<Client, ForgeConfigSpec> clientSpecPair = new ForgeConfigSpec.Builder().configure(TestConfig.Client::new);
